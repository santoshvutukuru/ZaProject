...
public class FlowMethods {
	...
	public void editGoalStatement(String moduleNmae)
	{
		...
		try
		{
			...
			System.out.println("StrategiesTestData.ACTIONS" +StrategiesTestData.ACTIONS);
			if(StrategiesTestData.ACTIONS.equalsIgnoreCase("EditGoal"))
			{
				System.out.println("StrategiesTestData.GOALSTMT"+StrategiesTestData.GOALSTMT);
			...
			{
				System.out.println("cameintoelse DiscardGoalStatement ");
